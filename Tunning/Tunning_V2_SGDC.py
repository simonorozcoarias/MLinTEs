...
# ### Sexto Tuneo: Stochastic Gradient Classifier
...
parameters = {'loss':['hinge', 'log', 'modified_huber', 'squared_hinge', 'perceptron'],
              ...
              'alpha':[1*(10**i)for i in range(-5,1,1)],
              'max_iter':[1*(10**i)for i in range(1,7,1)],
...
start_t = time.time()
tunned_clf = GridSearchCV(estimator,parameters, scoring=scoring, cv=CV, n_jobs=n_jobs, verbose=2)
...
tunnedModel = SGDClassifier(**finalParams,n_jobs=n_jobs)
